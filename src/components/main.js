...
{/*
 ...
 <div class="items">
        ...
        <div class="items">
			<div class="hS4">Most loved tech</div>
	...
	<div class="responsivecontainerFRChild">
      ...
      <div class="items">
			<div class="hS4">Movie, TV & Gaming Gifts</div>
        ...
        <div class="items">
			<div class="hS4">Engagement Gifts</div>
...
<div class="responsivecon2tainer3FRq" style={{marginTop:'20px'}}>
...
<div class="responsivecon2tainer3FRq" style={{marginTop:'20px'}}>
         ...
         <div class="Row1">
			...
			<div class="hS4">Last things you viewed</div>
				<div class="LSt_Cats1123">
...
<div class="responsivecontainerFR" style={{margin: '25px auto'}}>
      ...
      <div class="items">
        ...
        <div class="items">
			<div class="hS4">Gaming Corner</div>
...
<div class="responsivecon2tainer3FRq" style={{marginTop:'20px'}}>
         ...
         <div class="Row1">
			...
			<div class="hS4">Pc Components</div>
				<div class="LSt_Cats1123">
